...
// TestUserService_AvatarPersistsAcrossCacheRoundTrip and
// TestUserService_UpdateAvatarKey_RegeneratesURLAfterRefresh — the two tests
// that drive UserService against the real cache.RedisCache — live in
// redis_integration_test.go (integration-tagged, real Redis container).
