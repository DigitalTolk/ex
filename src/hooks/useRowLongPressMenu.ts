...
// The touch sidebar-row menu wiring shared by ChannelRow and
// ConversationRow: rows hide their kebab on touch devices — phones and iPads
// at any width — (pointer-events-none + opacity-0), so a long-press opens the
// controlled dropdown instead, and
